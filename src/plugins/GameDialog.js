...
export default class GameDialog extends Phaser.Plugins.ScenePlugin {
  ...
  _calculateWindowDimensions() {
    ...
    const y = gameHeight - this.windowHeight - this.padding;
    const width = gameWidth - (this.padding * 2);
